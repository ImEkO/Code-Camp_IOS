...
class AViewController: UIViewController {
    ...
    @IBOutlet var monlabel3: UILabel!
    ...
    */
    ...
    override func viewDidLoad() {
        ...
        self.monlabel.text = maVariableIneffacable.valueForKey("NOM") as? String
        self.monlabel2.text = maVariableIneffacable.valueForKey("PRENOM") as? String
        self.monlabel3.text = maVariableIneffacable.valueForKey("EMAIL") as? String
    }
    ...
    @IBAction func seDeconnecter(sender: UIButton) {
        ...
        maVariableIneffacable.setInteger(0, forKey: "estCO")
